...
BlrWriter.prototype.addString = function (c, s, encoding) {
    ...
    const encodedBuffer = iconv.encode(s, encoding);
    ...
    this.pos++;
    encodedBuffer.copy(this.buffer, this.pos, 0, len);
    this.pos += len;
};
...
BlrWriter.prototype.addMultiblockPart = function (c, s, encoding) {
    var buff = iconv.encode(s, encoding);
...
BlrReader.prototype.readString = function(encoding){
    ...
    str = iconv.decode(this.buffer.slice(this.pos, this.pos + len), encoding);
    this.pos += len;
    return str;
};
...
XdrWriter.prototype.addString = function(s, encoding) {
    ...
    this.pos += 4;
    encodedBuffer.copy(this.buffer, this.pos);
    this.pos += alen;
};
...
XdrReader.prototype.readText = function(len, encoding) {
    ...
    var r = iconv.decode(this.buffer.slice(this.pos, this.pos + len), encoding);
    this.pos += align(len);
    return r;
};
